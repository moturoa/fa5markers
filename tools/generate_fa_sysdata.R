...
#!! This is a copy of github.com/rstudio/fontawesome/tools/generate_fa_sysdata.R
# This script makes the dataset fa_tbl.
...
# Create `sysdata.rda`
usethis::use_data(fa_tbl, internal = FALSE, overwrite = TRUE)
